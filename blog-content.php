					...
					<div class="container px-md-0">
						<div class="row d-flex no-gutters">
							<div class="col-lg-12 pb-5 single">
								<div class="row">
                                  <div class="img img-blog w-100" style="background-image: url(images/bg_1.jpg);"></div>
									<div class="px-5 mt-4">
										<h1 class="mb-3">Black &amp; Gold Paint Face</h1>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis, eius mollitia suscipit, quisquam doloremque distinctio perferendis et doloribus unde architecto optio laboriosam porro adipisci sapiente officiis nemo accusamus ad praesentium? Esse minima nisi et. Dolore perferendis, enim praesentium omnis, iste doloremque quia officia optio deserunt molestiae voluptates soluta architecto tempora.</p>
										<br><div class="img img-blog-content" style="background-image: url(images/dd.jpg);"></div>
										...
										<div class="about-author d-flex p-4">
											<div class="bio mr-5">
												<img src="images/h.png" alt="Image placeholder" class="img-fluid mb-4">
											</div>
											<div class="desc">
										...
										<div class="pt-5 mt-5">
											...
											<ul class="comment-list">
												...
												<li class="comment">
													<div class="vcard bio">
														<img src="images/h.png" alt="Image placeholder">
													</div>
													...
													<ul class="children">
														<li class="comment">
															<div class="vcard bio">
																<img src="images/h1.png" alt="Image placeholder">
															</div>
															<div class="comment-body">
																<h3>John Doe</h3>
																<div class="meta">July 26, 2020 at 04:00pm</div>
											...
											<div class="comment-form-wrap col-md-12 pt-5">
												...
												<form action="#" class="p-3 p-md-5">
													<div class="row">
														...
														<div class="col-md-12">
															<div class="form-group">
																<input type="submit" value="Paylaş" class="btn py-3 px-4 btn-primary">
															</div>
														</div>
													</div>
												</form>
